...
design.names <- c("Adu.19w", "Adu.3w","Adu.34w","Adu.5w",
                  "IgG.19w", "IgG.3w", "IgG.34w", "IgG.5w", "male")
...
write.table(sumTable, 
            paste0("../../results/DEGs/DEGs_comparison_Adu_vs_IgG_FDRq_", 
...
for (i in allComparisons) {
  ...
  #output as txt file
  path <- paste("../../results/DEGs/DEGs_", title,"_FDRq_1.00.tsv", sep = "") 
  write.table(
    vTopTableAll,
    path,
    sep = "\t",
  ...
  path <- paste("../../results/DEGs/DEGs_",title,"_FDRq_0.05.tsv", sep = "") 
  write.table(
    vTopTable1,
    path,
    sep = "\t",
  ...
  path <- paste("../../results/DEGs/DEGs_",title,"_FDRq_0.10.tsv", sep = "") 
  write.table(
    vTopTable2,
    path,
    sep = "\t",
...
# get file list
files <- list.files(paste0("../../results/DEGs"))
...
for (i in files) {
 ...
 # comparison name
 comparison <- gsub("../../results/DEGs/DEGs_", "", i)
 ...
 if(num != 0) {
    ...
    # save
    path <- paste0("../../results/DEGs/volcano_", comparison, "_FDRq_", 
...
# read tables
week3 <- read.table("../../results/DEGs/DEGs_Adu.3w_vs_IgG.3w_FDRq_1.00.tsv", 
                    sep = "\t", header = TRUE)
rownames(week3) <- week3$gene_name_unique
week5 <- read.table("../../results/DEGs/DEGs_Adu.5w_vs_IgG.5w_FDRq_1.00.tsv", 
                    sep = "\t", header = TRUE)
rownames(week5) <- week5$gene_name_unique
week19 <- read.table("../../results/DEGs/DEGs_Adu.19w_vs_IgG.19w_FDRq_1.00.tsv",
                     sep = "\t", header = TRUE)
rownames(week19) <- week19$gene_name_unique
week34 <- read.table("../../results/DEGs/DEGs_Adu.34w_vs_IgG.34w_FDRq_1.00.tsv", 
                     sep = "\t", header = TRUE)
...
# save
pdf(paste0("../../results/DEGs/upset_plot_FDRq_", format(thresh, nsmall = 2), ".pdf"), 
    height = 6, width = 8)
upset_gene
```
