...
# read in counts data
counts <- read.delim(
  paste0("../../featureCounts/", tissue, "_counts_matrix.tsv"),
  header = TRUE,
  row.names = 1,
  sep = "\t")
...
path <- paste0("../../results/",folder,"/counts/CPM_before_filtering_and_normalization.tsv")
write.table(cpm, path, quote = FALSE, sep = "\t")

path <- paste0("../05_shiny/",folder,"/counts/CPM_before_filtering_and_normalization.tsv")
write.table(cpm, path, quote = FALSE, sep = "\t")
```
...
path <- paste0("../05_shiny/",folder,"/counts/CPM_after_filtering_and_normalization.tsv")
write.table(cpm, path, quote = FALSE, sep = "\t")
